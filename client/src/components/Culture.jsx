  ...
  return (
    <div className="culture-wrapper flex flex-col gap-10 px-20">
      ...
      <div className="culture-imgs h-screen grid grid-cols-4 grid-rows-3 gap-5">
        <Image
          src="/gucci.jpeg"
          styles="col-start-3 col-span-2 row-span-2"
        />
        <Image
          src="/trophy.jpeg"
          styles="col-start-2 col-span-1 row-start-1 row-span-1"
        />
        <Image
          src="/jjk.jpeg"
          styles="col-start-1 col-span-1 row-start-3 row-span-1"
        />
        <Subheader
          content="Our mission is to give every gamer something to be proud of."
          divStyles="col-start-1 row-start-2 items-end uppercase"
        />
        <Subheader
          ...
          divStyles="col-start-3 col-span-1 row-start-3 uppercase"
        />
      </div>
    </div>
  )
